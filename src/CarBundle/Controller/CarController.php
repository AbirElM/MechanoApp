...
class CarController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('car_show', array('id' => $car->getLicense()));
        }
    ...
    public function editAction(Request $request, Car $car)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('car_edit', array('id' => $car->getLicense()));
        }
    ...
    private function createDeleteForm(Car $car)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('car_delete', array('id' => $car->getLicense())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
